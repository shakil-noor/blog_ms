<div class="left-sidebar-pro">
    <nav id="sidebar" class="">
        <div class="sidebar-header">
            <a href="{{route('admin.home')}}"><img class="main-logo" src="{{ asset('assets/backsite/img/logo/logo.png') }}" alt="" /></a>
            <strong><a href="{{route('admin.home')}}"><img src="{{ asset('assets/backsite/img/logo/logosn.png') }}" alt="" /></a></strong>
        </div>
                ...
                <ul class="metismenu" id="menu1">
                    <li>
                        <a class="has-arrow" href="{{route('category.index')}}">
                                ...
                                <span class="mini-click-non">Blog Categories</span>
                            </a>
                        <ul class="submenu-angle" aria-expanded="true">
                            <li><a title="Dashboard v.1" href="{{route('category.create')}}"><span class="mini-sub-pro">Create New</span></a></li>
                            <li><a title="Dashboard v.2" href="{{route('category.index')}}"><span class="mini-sub-pro">View All</span></a></li>
                        </ul>
                    </li>
                    <li>
